 ...
 *
 */
public class ProductionCountryBean extends BaseBean {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ProductionCountryBean)) {
            return false;
        }
        
        final ProductionCountryBean other = (ProductionCountryBean) obj;
    ...
    public String toString() {
        ...
        builder.append("Country [isoCode=").append(isoCode);
