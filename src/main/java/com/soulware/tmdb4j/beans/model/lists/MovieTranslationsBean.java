...
import com.soulware.tmdb4j.beans.model.TranslationBean;

/**
 * 
 * @author Luka Obradovic, 2012
 *
 * Model: http://help.themoviedb.org/kb/api/movie-translations
 */
public class MovieTranslationsBean extends BaseBean {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MovieTranslationsBean)) {
            return false;
        }
        
        final MovieTranslationsBean other = (MovieTranslationsBean) obj;
    ...
    public String toString() {
        ...
        builder.append("MovieTranslations [id=");
        builder.append(id);
