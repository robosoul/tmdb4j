...
/**
 * Bean that stores company movies list.
 * 
 * @author Luka Obradovic, 2012
 * 
 * Model: http://help.themoviedb.org/kb/api/company-movies
 */
public class CompanyMoviesBean extends BaseBean {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CompanyMoviesBean)) {
            return false;
        }
        
        final CompanyMoviesBean other = (CompanyMoviesBean) obj;
    ...
    public String toString() {
        ...
        builder.append("CompanyMovies [id=").append(id);
